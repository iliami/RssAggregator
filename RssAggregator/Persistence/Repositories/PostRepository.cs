...
public class PostRepository(IAppDbContext DbContext) : IPostRepository
{
    ...
    public Task<PostDto[]> GetPostsAsync(PaginationParams? paginationParams = null,
    ...
    public Task<PostDto[]> GetByFeedIdAsync(Guid feedId, PaginationParams? paginationParams = null,
        SortingParams? sortingParams = null, CancellationToken ct = default)
        => DbContext.Posts.AsNoTracking()
    ...
    public Task<PostDto[]> GetByUserIdAsync(Guid userId, PaginationParams? paginationParams = null,
        SortingParams? sortingParams = null, CancellationToken ct = default)
        => DbContext.Posts.AsNoTracking()
