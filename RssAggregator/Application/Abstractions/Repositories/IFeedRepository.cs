...
public interface IFeedRepository
{
    ...
    Task<IEnumerable<FeedDto>> GetFeedsAsync(PaginationParams? paginationParams = null, CancellationToken ct = default);
    Task<IEnumerable<FeedDto>> GetByUserIdAsync(Guid userId, PaginationParams? paginationParams = null, CancellationToken ct = default);
