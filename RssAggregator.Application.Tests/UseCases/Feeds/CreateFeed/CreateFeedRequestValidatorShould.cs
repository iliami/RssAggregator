...
public class CreateFeedRequestValidatorShould
{
    ...
    public static IEnumerable<object[]> GetInvalidRequests()
    {
        ...
        yield return
            [ValidRequest with { Url = string.Concat(Enumerable.Repeat("example.", 30)) + "8times30.equal240" }];
    ...
    public static IEnumerable<object[]> GetValidRequests()
    {
        ...
        yield return
            [ValidRequest with { Url = "example.com/some/url/to/file.xml?somequery1=value1&somequery2=value2" }];
        yield return
            [ValidRequest with { Url = "www.example.com/some/url/to/file.xml?somequery1=value1&somequery2=value2" }];
        ...
        yield return
        [
            ValidRequest with { Url = "https://example.com/some/url/to/file.xml?somequery1=value1&somequery2=value2" }
        ];
